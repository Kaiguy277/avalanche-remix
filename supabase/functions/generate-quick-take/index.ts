...
For ALL zone counts: Lead with the most critical safety information. Focus on the next 2-3 days. Use the WEATHER FORECAST data — incoming storms, wind events, and temperature changes are the most actionable information.
</instructions>
